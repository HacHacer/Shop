...
<head>
    ...
    <title>锡货超市</title>
    <link href="/Shop/Public/Car/css/public.css" type="text/css" rel="stylesheet"/>
    <link rel="stylesheet" type="text/css" href="/Shop/Public/Car/css/base.css"/>
    <script type="text/javascript" src="/Shop/Public/Car/js/jquery_cart.js"></script>
    <link rel="stylesheet" type="text/css" href="/Shop/Public/Car/css/buyConfirm.css" />
    <script src="/Shop/Public/Car/js/jquery-1.11.1.min.js" type="text/javascript"></script>
    <script src="/Shop/Public/Car/js/unslider.min.js" type="text/javascript"></script>
    <script src="/Shop/Public/Car/js/index.js" type="text/javascript"></script>
...
<div class="border_top_cart">
    <div class="container payment-con">
        <form target="_blank" action="sucss" id="pay-form" method="post">
            <div class="order-info">
                ...
                <div class="info">
                    <p>
                        金额：<span class="pay-total"><?php echo ($oid["Ordermoney"]); ?>元</span>
                    </p>
                    <p>
                        订单：<?php echo ($oid["Orderid"]); ?>                </p>
                    <p>
                        配送：<?php echo ($add["cname"]); ?>                                    <span class="line">/</span>
                        联系电话：<?php echo ($add["phone"]); ?>                                <span class="line">/</span>
                       <?php echo ($add["sheng"]); ?>,<?php echo ($add["shi"]); ?>,<?php echo ($add["qu"]); ?> <?php echo ($add["adetial"]); ?>                                                            <span class="line">/</span>
                        不限送货时间                                    <span class="line">/</span>
                        个人电子发票                                                    </p>
                </div>
                <div class="icon-box">
                    <i class="iconfont"><img src="/Shop/Public/Car/images2/yes_ok.png"></i>
                </div>
            </div>
                                ...
                                <dd>
                                    <fieldset id="test4-input-input_tab1-input_tab2" style=" border:none;">
                                        <ul class="payment-list clearfix" >
                                            <li> <input class="input_tab1" name="myradio" id="r1" type="radio" checked="checked"/><label for="r1" ><img src="/Shop/Public/Car/images2/xhw.png" alt=""/></label></label></li>
                                            <li><input class="input_tab2" name="myradio" id="r2" type="radio" /><label for="r2" ><img src="/Shop/Public/Car/images2/zfb.png" alt=""/></label></li>
                                            <li> <input class="input_tab2" name="myradio" id="r3" type="radio" /><label for="r3" ><img src="/Shop/Public/Car/images2/yck.png" alt=""/></label></li>
                                            <li>  <input class="input_tab2" name="myradio" id="r4" type="radio" /><label for="r4" ><img src="/Shop/Public/Car/images2/zxzf.png" alt=""/></label></li>
                                        </ul>
                                        <div >
                                            <div id="test4_1">
...
<script type="text/javascript" src="/Shop/Public/Car/js/buyConfirm.js"></script>
...
<div class="fixed-buttons">
    <ul>
        <li><a href="#" class="fixed-weixin"><img src="/Shop/Public/Car/images2/fixed_weixin.png" /><div class="weixin-pic"><img src="images/weixin_big.jpg"></div></a></li>
        <li><img id="imgBtn-to-top" src="/Shop/Public/Car/images2/back_top.png" /></li>
    </ul>
</div>

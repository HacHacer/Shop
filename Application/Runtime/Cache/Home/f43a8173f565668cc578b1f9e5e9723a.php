...
<!--
var pic = new Image();
pic.src="/Shop/Public/Back/images/arrow_right.gif";
...
function toggleMenu()
{
  ...
  {
    frmBody.cols="200, 10, *";
    imgArrow.src = "/Shop/Public/Back/images/arrow_left.gif";
  }
  else
  {
    frmBody.cols="0, 10, *";
    imgArrow.src = "/Shop/Public/Back/images/arrow_right.gif";
  }
}
...
<table height="100%" cellspacing="0" cellpadding="0" id="tbl">
  <tbody><tr><td><a href="javascript:toggleMenu();"><img src="/Shop/Public/Back/images/arrow_left.gif" width="10" height="30" id="img" border="0"></a></td></tr>
</tbody></table>

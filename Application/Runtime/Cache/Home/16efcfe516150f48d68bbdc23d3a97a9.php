...
<body>
   ...
   <div class="main">
   	 <div class="wrap">
    		...
    		<p><a href="index.html">首页</a> &gt;&gt;&gt;&gt; <a href="#" class="active">商品详情</a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
				...
				<div class="cont-desc span_1_of_2">
				  <div class="product-details">				
					<div class="grid images_3_of_2">
						<img src="<?php echo ($product["pimg"]); ?>" alt="" />
				  </div>
				<div class="desc span_3_of_2">
					<h2><?php echo ($product["pname"]); ?></h2>
					<p><?php echo ($product["pnote"]); ?></p>
					<div class="price">
						<p>惊爆价: <span>$<?php echo ($product["pprice"]); ?></span></p>
					</div>
					<div class="available">
						<ul>
						  <li><span>选择款式:</span> &nbsp; Model 1</li>
						  <li><span>选择尺码:</span>&nbsp; 5lbs</li>
						  <li><span>该商品仅剩:</span>&nbsp;<?php echo ($product["pcount"]); ?>件</li>
					    </ul>
					</div>

				<div class="share-desc">
					<form action="addtocar" method="post" name="docc">
					<div class="share">
						<input type="hidden" name="pid" value="<?php echo ($product["pid"]); ?>">
						<p>选择购买数量:</p><input class="text_box" value="1" type="number" name="pcount" min="1">
					</div>
					</form>
					<script>
                        function subform(){
                            document.docc.submit();
                        }
					</script>
					<div class="button"><span><a href="#" onclick="subform()">立即购买</a></span></div>
					<div class="button"><span><a href="addtocar?pid=<?php echo ($product["pid"]); ?>" onclick="subform()">加入购物车</a></span></div>
					<div class="clear"></div>
				</div>

				 <div class="wish-list">
				 	<ul>
				 		<li class="wish"><a href="#">加入愿望单</a></li>
				 	    <li class="compare"><a href="#">加入比较</a></li>
				 	</ul>
				 </div>
			</div>
			<div class="clear"></div>
		...
		<div class="product_desc">
			 <h2>商品细节:</h2>
			<?php echo htmlspecialchars_decode($product['pdetial']);?>
	   </div>
   </div>
			<div class="rightsidebar span_3_of_1 sidebar">
				<h2>同类商品</h2>

			<?php if(is_array($samepro)): $i = 0; $__LIST__ = $samepro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pro): $mod = ($i % 2 );++$i;?><div class="special_movies">
						<div class="movie_poster">
							<a href="preview.html"><img src="<?php echo ($pro["pimg"]); ?>" alt="" /></a>
						</div>
						<div class="movie_desc">
							<h3><a href="preview?pid=<?php echo ($pro["pid"]); ?>"><?php echo ($pro["pname"]); ?></a></h3>
							<p><span> $<?php echo ($pro["pprice"]); ?></span> $<?php echo ($pro["pprice"]); ?></p>
							<span><a href="addtocar?pid=<?php echo ($pro["pid"]); ?>">加入购物车</a></span>
						</div>
						<div class="clear"></div>
			...
			<div class="rightsidebar span_3_of_1 sidebar">
				<h2>热销商品</h2>
			<?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pro): $mod = ($i % 2 );++$i;?><div class="special_movies">
						<div class="movie_poster">
							<a href="preview.html"><img src="<?php echo ($pro["pimg"]); ?>" alt="" /></a>
						</div>
						<div class="movie_desc">
